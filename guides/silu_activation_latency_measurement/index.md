...
|---|---|---|
| [Ch 1 — SiLU in MoE Architecture](ch01_silu_in_moe_architecture/index.md) | Establishes the computational context: where SiLU appears in the SwiGLU FFN graph, why MoE dispatch makes per-expert SiLU invocations non-trivial, and the cost hypothesis that motivates measurement. | [`ffn_compute_graph.md`](ch01_silu_in_moe_architecture/ffn_compute_graph.md), [`swiglu_variant.md`](ch01_silu_in_moe_architecture/swiglu_variant.md), [`compute_role_and_cost_hypothesis.md`](ch01_silu_in_moe_architecture/compute_role_and_cost_hypothesis.md) |
| [Ch 2 — SiLU on Wormhole Hardware](ch02_silu_on_wormhole_hardware/index.md) | Explains how SiLU maps to SFPU LLK instructions inside a Tensix core, why it cannot overlap with the preceding FPU matmul, and how to place it on the Wormhole B0 roofline. | [`tensix_compute_engine.md`](ch02_silu_on_wormhole_hardware/tensix_compute_engine.md), [`silu_sfpu_execution.md`](ch02_silu_on_wormhole_hardware/silu_sfpu_execution.md), [`cycles_vs_matmul.md`](ch02_silu_on_wormhole_hardware/cycles_vs_matmul.md) |
| [Ch 3 — Measuring SiLU Latency](ch03_measuring_silu_latency/index.md) | Provides a hands-on benchmark methodology: enabling the TTNN device profiler, structuring warm-up loops, reading `DEVICE KERNEL DURATION [ns]` from the Tracy CSV, and two strategies for isolating SiLU from surrounding matmuls. | [`profiling_setup.md`](ch03_measuring_silu_latency/profiling_setup.md), [`isolating_silu_from_matmul.md`](ch03_measuring_silu_latency/isolating_silu_from_matmul.md), [`measurement_methodology.md`](ch03_measuring_silu_latency/measurement_methodology.md) |
| [Ch 4 — SiLU vs. Matmul Comparison](ch04_silu_vs_matmul_comparison/index.md) | Uses the Chapter 3 methodology to produce a roofline analysis and a latency ratio table across `num_tokens ∈ {1, 8, 32, 128}` and `hidden_dim ∈ {2048, 4096, 8192}`. Derives the `num_tokens = 16` decode/prefill crossover threshold. | [`roofline_analysis.md`](ch04_silu_vs_matmul_comparison/roofline_analysis.md), [`latency_ratio_by_shape.md`](ch04_silu_vs_matmul_comparison/latency_ratio_by_shape.md), [`compute_vs_memory_bound_regimes.md`](ch04_silu_vs_matmul_comparison/compute_vs_memory_bound_regimes.md) |
| [Ch 5 — Fused Activation Strategies](ch05_fused_activation_strategies/index.md) | Documents the TTNN APIs for fusing SiLU into the preceding matmul kernel. Defines Pattern A (fused, 3 dispatches) and Pattern B (unfused baseline, 4 dispatches), covers `activation_dtype` precision tradeoffs, and identifies when sharded tensors require the program config path. | [`ttnn_fused_activation_api.md`](ch05_fused_activation_strategies/ttnn_fused_activation_api.md), [`swiglu_fusion_pattern.md`](ch05_fused_activation_strategies/swiglu_fusion_pattern.md), [`activation_dtype_and_precision.md`](ch05_fused_activation_strategies/activation_dtype_and_precision.md) |
| [Ch 6 — Performance Impact and Recommendations](ch06_performance_impact_and_recommendations/index.md) | Synthesizes all findings into a quick-reference recommendation table covering decode (BF16 and BFP8), prefill, and T3K expert-parallel scenarios. Includes a Tracy profiler verification checklist and open questions for future work. | [`when_fusion_helps.md`](ch06_performance_impact_and_recommendations/when_fusion_helps.md), [`configuration_recommendations.md`](ch06_performance_impact_and_recommendations/configuration_recommendations.md), [`measurement_summary_and_next_steps.md`](ch06_performance_impact_and_recommendations/measurement_summary_and_next_steps.md) |
